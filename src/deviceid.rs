 ...
 * {@code destLen}==0.
 */
    pub fn HAL_device_ID(dest: *mut u8, destLen: ::ctypes::c_uint)
     -> ::ctypes::c_uint;
}
extern "C" {
    /**
 ...
 */
    pub fn HAL_Platform_ID() -> ::ctypes::c_uint;
}
extern "C" {
    /**
 *
 */
    pub fn HAL_Get_Device_Identifier(name: *mut *const ::ctypes::c_char,
                                     buf: *mut ::ctypes::c_char,
                                     buflen: usize, index: ::ctypes::c_uint,
 ...
 */
    pub fn HAL_save_device_id(offset: u32);
}
