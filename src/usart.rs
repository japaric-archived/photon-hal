...
pub const TOTAL_USARTS: ::ctypes::c_uint = 2;
pub const SERIAL_BUFFER_SIZE: ::ctypes::c_uint = 64;
...
pub struct Ring_Buffer {
    pub buffer: [u16; 64usize],
    pub head: u16,
    pub tail: u16,
}
#[test]
fn bindgen_test_layout_Ring_Buffer() {
    assert_eq!(::core::mem::size_of::<Ring_Buffer>() , 132usize , concat ! (
               "Size of: " , stringify ! ( Ring_Buffer ) ));
    assert_eq! (::core::mem::align_of::<Ring_Buffer>() , 2usize , concat ! (
                "Alignment of " , stringify ! ( Ring_Buffer ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Ring_Buffer ) ) . buffer as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( Ring_Buffer ) , "::" ,
                stringify ! ( buffer ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Ring_Buffer ) ) . head as * const _ as
                usize } , 128usize , concat ! (
                "Alignment of field: " , stringify ! ( Ring_Buffer ) , "::" ,
                stringify ! ( head ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const Ring_Buffer ) ) . tail as * const _ as
...
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum HAL_USART_Serial { HAL_USART_SERIAL1 = 0, HAL_USART_SERIAL2 = 1, }
extern "C" {
    pub fn HAL_USART_Init(serial: HAL_USART_Serial,
                          rx_buffer: *mut Ring_Buffer,
                          tx_buffer: *mut Ring_Buffer);
}
extern "C" {
    pub fn HAL_USART_Begin(serial: HAL_USART_Serial, baud: u32);
}
extern "C" {
    pub fn HAL_USART_End(serial: HAL_USART_Serial);
}
extern "C" {
    pub fn HAL_USART_Write_Data(serial: HAL_USART_Serial, data: u8) -> u32;
}
extern "C" {
    pub fn HAL_USART_Available_Data_For_Write(serial: HAL_USART_Serial)
     -> i32;
}
extern "C" {
    pub fn HAL_USART_Available_Data(serial: HAL_USART_Serial) -> i32;
}
extern "C" {
    pub fn HAL_USART_Read_Data(serial: HAL_USART_Serial) -> i32;
}
extern "C" {
    pub fn HAL_USART_Peek_Data(serial: HAL_USART_Serial) -> i32;
}
extern "C" {
    pub fn HAL_USART_Flush_Data(serial: HAL_USART_Serial);
}
extern "C" {
    pub fn HAL_USART_Is_Enabled(serial: HAL_USART_Serial) -> bool;
}
extern "C" {
    pub fn HAL_USART_Half_Duplex(serial: HAL_USART_Serial, Enable: bool);
}
extern "C" {
    pub fn HAL_USART_BeginConfig(serial: HAL_USART_Serial, baud: u32,
                                 config: u32, arg1: *mut ::ctypes::c_void);
}
extern "C" {
    pub fn HAL_USART_Write_NineBitData(serial: HAL_USART_Serial, data: u16)
     -> u32;
}
extern "C" {
    pub fn HAL_USART_Send_Break(serial: HAL_USART_Serial,
                                reserved: *mut ::ctypes::c_void);
}
extern "C" {
    pub fn HAL_USART_Break_Detected(serial: HAL_USART_Serial) -> u8;
}
